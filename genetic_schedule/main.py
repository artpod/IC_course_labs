...
class GeneticScheduler: # Головний клас, що реалізує генетичний алгоритм для розкладу.
    ...
    def generate_random_schedule(self): # Створює випадковий розклад, використовуючи вхідні дані (викладачі, предмети тощо).
        schedule = []
    ...
    @staticmethod
    def calculate_fitness(schedule): # Визначає "здоров'я" розкладу. Чим менше конфліктів в розкладі, тим краще "здоров'я".
    ...
    def crossover(self, schedule1, schedule2): # Реалізація схрещування (кросоверу). Об'єднує частини двох розкладів, щоб створити два нових розклади.
